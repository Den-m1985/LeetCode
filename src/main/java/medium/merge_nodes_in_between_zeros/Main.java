...
class Main {
    ...
    of integers separated by 0's. The beginning and end of the linked list will have Node.val == 0.
    ...
    public static void main(String[] args) {
        ...
        for (Data data : arrayData) {
            ...
            ListNode result = new MySolution().mergeNodes(data.getListNode());
            System.out.println("Time in mlSec: " + (System.currentTimeMillis() - start));
    ...
    static ArrayList<Data> fillArray() {
        ...
        Data data1 = new Data(new int[]{0,3,1,0,4,5,2,0}, new int[]{4,11});
        Data data2 = new Data(new int[]{0,1,0,3,0,2,2,0}, new int[]{1,3,4});
        arrayData.add(data1);
        arrayData.add(data2);
        return arrayData;
    }
